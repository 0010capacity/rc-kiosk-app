...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'default', ...props }, ref) => {
    ...
    const variantClasses = {
      default:
        'bg-redCross text-white hover:bg-red-700 focus-visible:ring-redCross',
      primary:
        'bg-redCross text-white hover:bg-red-700 focus-visible:ring-redCross',
      secondary:
        'bg-gray-100 text-gray-800 hover:bg-gray-200 border border-gray-300 focus-visible:ring-gray-300',
      ghost:
        'bg-transparent text-black hover:bg-gray-100 border border-gray-300 focus-visible:ring-gray-300',
      subtle:
        'bg-gray-100 text-gray-800 hover:bg-gray-200 border border-gray-300 focus-visible:ring-gray-300',
      danger:
        'bg-red-100 text-redCross hover:bg-red-200 border border-red-300 focus-visible:ring-redCross',
      outline:
